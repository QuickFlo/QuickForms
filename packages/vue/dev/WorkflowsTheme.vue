    ...
    steps: {
      ...
      items: {
        ...
        properties: {
          ...
          action: {
            type: 'string',
            enum: ['api_call', 'send_email', 'transform_data', 'wait', 'conditional', 'loop', 'parallel'],
            title: 'Action Type',
    ...
    <div class="workflows-header">
      <div class="header-content">
        ...
        <p class="header-subtitle">
          Testing CSS variable overrides to match workflows app styling without Quasar components
        </p>
      </div>
    </div>
